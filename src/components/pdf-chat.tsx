...
export function PDFChat({ documentId, documentContent, documentName }: PDFChatProps) {
  ...
  return (
    <div className="relative rounded-2xl border bg-gradient-to-b from-background to-muted/10 shadow-md overflow-hidden">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-gradient-to-r from-primary/20 via-orange-400/20 to-red-400/20 rounded-full blur-3xl opacity-50 pointer-events-none" />
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center animate-fade-in text-sm">
              ...
              <div className="relative mb-6">
                <div className="absolute inset-0 bg-gradient-to-r from-primary via-orange-400 to-red-400 rounded-full blur-xl opacity-50 animate-pulse" />
                <div className="relative w-20 h-20 rounded-full bg-gradient-to-br from-primary to-orange-500 flex items-center justify-center shadow-2xl">
              ...
              {messages.map((message, index) => (
                ...
                >
                  {message.role === 'assistant' && (
                    <div className="shrink-0 w-10 h-10 rounded-full bg-gradient-to-br from-primary to-orange-500 flex items-center justify-center shadow-lg">
            ...
            <div className="relative flex items-end gap-2 p-2 rounded-2xl border bg-background shadow-lg focus-within:ring-2 focus-within:ring-primary/20 focus-within:border-primary/50 transition-all">
              ...
              <Button 
                ...
                className={cn(
                  ...
                  input.trim() 
                    ? "bg-gradient-to-r from-primary to-orange-500 hover:opacity-90 shadow-lg" 
